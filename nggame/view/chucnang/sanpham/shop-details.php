...
include_once "../controller/shopgriddetailcontroller.php";
?>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div ><del><?php  echo number_format($row['don_gia'], 0, '', '.')." VNĐ"; ?></del></div>
                        <div class="product__details__price"><?php  echo number_format($row['don_gia'], 0, '', '.')." VNĐ"; ?></div>
