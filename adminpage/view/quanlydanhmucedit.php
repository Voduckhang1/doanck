                        ...
                        <div class="card-body card-block">
                            ...
                            <form  method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="ten_dm_sp" name="ten_dm_sp"
                                    value="<?php if(isset($_POST['ten_dm_sp'])){echo $_POST['ten_dm_sp'];}else {echo $row['ten_dm_sp'];} ?> "class="form-control"></div>
                                </div>
